    ...
    return GestureDetector(
      ...
      onTap:(){
        ...
        if (widget.check == true){
          AlertDialog(
            title: const Text("Your score is 1"),
            content: const Text("Have fun"),
            actions: <Widget>[
              ElevatedButton(
              child: const Text("OK"),
              onPressed:(){
      ...
      //margin: const EdgeInsets.only(bottom: 70),
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("Welcome to Quiz App", style: TextStyle(fontSize: 25, color: Colors.black, fontWeight: FontWeight.bold),),
        ...
        body:Center(
          child: Row(
            ...
            children:const <Widget>[
              LayoutFlutter('https://esquilo.io/png/thumb/GRqoSib7eDiGGTL-Quiz-Logo-PNG-HD.png', 'Bangkok',
