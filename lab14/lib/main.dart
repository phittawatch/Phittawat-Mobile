import 'package:excercise9_problem3/screens/restart.dart';
    ...
    return Expanded(child: Container(
      //margin: const EdgeInsets.only(bottom: 70),
        child: Column(
          ...
          children: <Widget>[
            Text("Where is this picture?", style: TextStyle(fontSize: 25, color: Colors.pink),),
            Image(image: NetworkImage(widget.image), height: 200, width: 300),
            Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  Expanded(child: ParentWidget(u_name: widget.choice1, show_color: Colors.blueAccent, check: true,
                  ),),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Container(margin: const EdgeInsets.only(left: 95.0)),
              ...
              Container( //margin: const EdgeInsets.only(left: 80.0),
                  child: ElevatedButton(
...
class _Navigation_routeState extends State<Navigation_route> {
  @override
  Widget build(BuildContext context) {
    return Container(alignment: FractionalOffset.bottomRight,
        child: ElevatedButton(
        child: const Text('NEXT'),
    onPressed: () {
      Navigator.push(
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: MediaQuery.of(context).orientation  == Orientation.landscape
            ? null
            : AppBar(
          title: const Text('Question 1'), backgroundColor: Colors.blue,
        ),
        body:Center(
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children:const <Widget>[
              LayoutFlutter('https://i0.wp.com/www.kku.ac.th/wp-content/uploads/2019/05/kku-768x432.jpg', 'Khon Kaen University',
              "Chiang mai University", "Chulalongkorn University", "Mahidol University"),
            ],
          ),
        ),
      ),
