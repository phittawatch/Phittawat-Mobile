...
class WriteExample extends StatefulWidget {
  final user;
  final dayname;
  WriteExample({Key? key, required this.user, required this.dayname})
      : super(key: key);
...
class _WriteExampleState extends State<WriteExample> {
  ...
  Widget build(BuildContext context) {
    ...
    final SetFinish = _database.child(
        'user/${widget.user.displayName!}/Plan/0/Training/0/Train/Repeat/');
    SetFinish.update({'${widget.dayname}': 'True'})
